...
Dans un premier temps le re-typage des variables est nécessaire, certains ID peuvent être interprétés comme des valeurs numériques alors qu’ils sont des modalités, le principe est le même pour les booléens.
...
```{r credit14, echo=TRUE,  message=FALSE, warning=FALSE, fig.align='center'}
...
```{r credit141, echo=TRUE,  message=TRUE, warning=FALSE, fig.align='center'}
...
```{r credit15, echo=TRUE,  message=FALSE, warning=FALSE, fig.align='center'}
#creating indices
...
```{r credit151, echo=TRUE,  message=TRUE, warning=FALSE, fig.align='center'}

ggplot(training1_TEST, aes(x=Score, color=loan_default)) +
  geom_density()

```
Comme attendu, les scores des clients tombant en défaut sont distribués dans les valeurs plus élevées.
...
Le tracé des séries temporelles peut se faire avec le package ramCHarts, qui donne un rendu dynamique de vos graphiques :

```{r quant2, echo=TRUE,  message=FALSE, warning=FALSE, layout="l-body-outset"}
...
```{r quant3, echo=TRUE,  message=FALSE, warning=FALSE, layout="l-body-outset"}
...
```{r quant4, echo=TRUE,  message=FALSE, warning=FALSE, layout="l-body-outset"}
...
```{r quant5, echo=TRUE,  message=FALSE, warning=FALSE, layout="l-body-outset"}
...
```{r quant7, echo=TRUE,  message=FALSE, warning=FALSE, layout="l-body-outset"}
...
```{r quant9, echo=TRUE,  message=FALSE, warning=FALSE, layout="l-body-outset"}
...
```{r quant10, echo=TRUE,  message=FALSE, warning=FALSE, layout="l-body-outset"}
